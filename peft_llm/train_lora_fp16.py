"""
LoRA FP16 Baseline Training Script
Based on QLoRA code but without 4-bit quantization
"""
import torch
...
def main():
    ...
    try:
        ...
        print(f"  ✓ 分词完成")
        print(f"    处理后训练集字段: {tokenized_dataset['train'].column_names}")
